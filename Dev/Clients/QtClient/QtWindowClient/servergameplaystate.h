...
namespace ServerUtils
{
    ...
    inline Comparer operator~ (Comparer a) { return static_cast<Comparer>(~static_cast<int>(a)); }
    inline Comparer operator| (Comparer a, Comparer b) { return static_cast<Comparer>(static_cast<int>(a) | static_cast<int>(b)); }
    inline Comparer operator& (Comparer a, Comparer b) { return static_cast<Comparer>(static_cast<int>(a) & static_cast<int>(b)); }
    inline Comparer operator^ (Comparer a, Comparer b) { return static_cast<Comparer>(static_cast<int>(a) ^ static_cast<int>(b)); }
    inline Comparer& operator|= (Comparer& a, Comparer b) { a = static_cast<Comparer>(static_cast<int>(a) | static_cast<int>(b)); return a;}
    inline Comparer& operator&= (Comparer& a, Comparer b) { a = static_cast<Comparer>(static_cast<int>(a) & static_cast<int>(b)); return a;}
    inline Comparer& operator^= (Comparer& a, Comparer b) { a = static_cast<Comparer>(static_cast<int>(a) ^ static_cast<int>(b)); return a;}
    ...
    {
        QString Target = "";
        Comparer Comparer = Comparer::Smaller;
        int Value = -1;
    };
    ...
    struct ServerGameplayState
    {
        ...
        void SetDataData(QJsonObject jsonData)
        {
            ...
            for(int index = 0; index < nbUpgrades; ++index)
            {
                ...
                QJsonObject lock = jsonUpgrade["Lock"].toObject();
                upgrade->Lock.Target = lock["Target"].toString();
                if(upgrade->Lock.Target != "None")
                {
                    upgrade->Lock.Value = lock["Value"].toInt();
                    int intComparer = lock["Comparer"].toInt();
                    upgrade->Lock.Comparer = static_cast<Comparer>(intComparer);
                }
